public class Inheritance 
{
	public static void main(String[] args) {
		Student student1 = new Student("Hazel", " Brgy. PBW Calaca, Batangas", "BSIT", 2);
        ...
        System.out.println();
		Staff staff1 = new Staff("Elloi", "Brgy. PBE Calaca, Batangas", "Batangas State University", 500.00f );
